    ...
    <div class="sidebar os-host os-host-overflow os-host-overflow-y os-host-resize-disabled os-host-transition os-theme-dark os-host-overflow-x">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="#" class="nav-link @yield('profile_guru') @yield('profile_siswa')">
              <i class="nav-icon fas fa-copy"></i>
              <p>
                Profile
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="/guru/profile" class="nav-link @yield('profile_guru')">
                  <i class="far fa-user nav-icon"></i>
                  <p>Profile Guru</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="pages/layout/top-nav-sidebar.html" class="nav-link @yield('profile_siswa')">
                  <i class="far fa-user nav-icon"></i>
                  <p>Profile Siswa</p>
                </a>
              </li>
